class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :phone, :email, :mytutor_ids, :mystudent_ids, :bio, :photo, :password, :pro, :password_confirmation, :remember_me])

    # For additional in app/views/devise/registrations/edit.html.erb
    devise_parameter_sanitizer.permit(:account_update, keys: [:first_name, :last_name, :phone, :bio, :birthdate, :mytutor_ids, :mystudent_ids, :pro, :email, :photo, :password, :password_confirmation, :remember_me])
  end
