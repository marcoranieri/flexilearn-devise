...
100.times do
  ...
  less = Lesson.new(title: "Need help with #{Faker::BossaNova.song}", request: Faker::Lorem.paragraph, date: Faker::Date.forward(300), time: Time.now , location: Faker::Address.full_address, status: rand(0..2), price_cents: rand(2000..8000), notes: Faker::StarWars.quote, tutor_notes: Faker::Lorem.paragraph)
  less.category = cat
  less.tutor = tut
  less.student = stu
